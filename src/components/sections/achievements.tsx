            ...
            {achievementsData.map((item, index) => (
              <MotionWrapper key={index} amount={0.5} variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0 } }}>
                <div className="relative flex items-center">
                  ...
                  <div className="absolute left-1/2 z-10 h-8 w-8 -translate-x-1/2 transform rounded-full border-4 border-background bg-primary flex items-center justify-center">
